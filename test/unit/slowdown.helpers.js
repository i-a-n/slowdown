...
describe('encodeEmailAddress()', function () {
  'use strict';
  let encoder = slowdown.helper.encodeEmailAddress,
...
describe('isString()', function () {
  'use strict';
  let isString = slowdown.helper.isString;
...
describe('isFunction()', function () {
  'use strict';
  let isFunction = slowdown.helper.isFunction;
...
describe('isArray()', function () {
  'use strict';
  let isArray = slowdown.helper.isArray;
...
describe('isUndefined()', function () {
  'use strict';
  let isUndefined = slowdown.helper.isUndefined;
...
describe('stdExtName()', function () {
  'use strict';
  let stdExtName = slowdown.helper.stdExtName;
...
describe('forEach()', function () {
  'use strict';
  let forEach = slowdown.helper.forEach;
...
describe('matchRecursiveRegExp()', function () {
  ...
  let rRegExp = slowdown.helper.matchRecursiveRegExp;
  ...
  it('work produce the same output as String.prototype.repeat()', function () {
    if (typeof String.prototype.repeat !== 'undefined') {
      let str = 'foo',
          ...
          actual = slowdown.helper.repeat(str, 100);
